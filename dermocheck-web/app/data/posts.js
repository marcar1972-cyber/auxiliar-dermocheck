...
export const blogPosts = [
    {
      ...
      content: `
        ...
        <ul class="list-disc pl-5 mb-4 space-y-2">
            ...
            <li><strong>Precaución:</strong> Muchas veces estos packs se arman para rotar stock próximo a vencer. <strong>Siempre verifica el Batch Code</strong> antes de llevarlo usando nuestra <a href="/" class="text-ruby font-bold hover:underline">herramienta gratuita DermoCheck</a>.</li>
        </ul>
        ...
        <div class="bg-gray-50 p-4 border-l-4 border-ruby my-6">
            <p class="font-bold text-dark text-sm mb-2">💡 DATO PRO: Formatos "Gigantes" en Amazon</p>
            <p class="text-sm text-gray-600 mb-2">En Chile, el protector facial estándar trae 50ml. En Amazon puedes encontrar el <strong>Eucerin Advanced Hydration con Ácido Hialurónico</strong> (el de la foto de portada) en formato de <strong>150ml (5 oz)</strong>.</p>
            <p class="text-sm text-gray-600 mb-3">Es decir: <strong>3 veces más producto</strong> por un precio muy similar al de farmacia local.</p>
            <a href="https://amzn.to/TU_LINK_DE_EUCERIN_ADVANCED_AQUI" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-1 text-ruby font-bold text-sm hover:underline">
        ...
        <p class="mb-4">¿Vale la pena? Solo si lo vas a usar de inmediato. Si es para guardar, estás botando plata. Usa el <a href="/" class="text-ruby font-bold hover:underline">verificador de lotes</a> para saber la fecha exacta de fabricación si el envase solo trae el código impreso.</p>
